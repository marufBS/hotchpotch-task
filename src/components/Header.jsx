...
const Header = () => {
    return (
        <>
            <div className=" text-white flex items-center justify-center my-15 md:my-30">
                ...
                <div className="text-center">
                    ...
                    <p className=" text-md md:text-lg mb-8 font-[Inter] text-gray-400">
                        Artificial intelligence writting tool helps you create blogs,<br /> social media websites and much more.
                    </p>

                    <div className="flex flex-col md:flex-col items-center justify-center gap-4 font-[Inter]">
                        <a href="#" className="bg-gradient-to-r from-[#2B59FF] to-[#BB2BFF] text-white py-3 px-8 rounded-lg shadow-md text-lg font-semibold hover:scale-105 transition-transform">
                            Start 14 Days Free Trial
                        </a>
                        <a href="#" className="flex items-center text-gray-300 hover:text-white text-lg font-medium gap-2">
                            <CirclePlay /> Watch A Demo
                        </a>
                    </div>
                </div>
            </div >
            <hr className="h-px mx-8 bg-black border-0 dark:bg-gray-700"></hr>
        </>
    )
}
